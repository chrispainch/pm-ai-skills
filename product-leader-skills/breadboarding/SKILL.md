...
When the breadboard is a durable initiative artifact, follow the [Product Artifact Contract](../../references/product-artifact-contract.md): write it to `product/initiatives/<initiative-id>/flow.md` and register it in `manifest.yaml`.
