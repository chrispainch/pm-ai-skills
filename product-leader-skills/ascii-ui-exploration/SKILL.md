...
When the selected direction needs a durable record, follow the [Product Artifact Contract](../../references/product-artifact-contract.md): write it to `product/initiatives/<initiative-id>/ui-exploration.md` and register it in `manifest.yaml`.
