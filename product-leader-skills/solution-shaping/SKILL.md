...
- write a solution artifact that should guide implementation
...
- "Write the implementation-guiding solution artifact."
...
- Carry forward the linked product direction and its relevant strategic outcome or boundary.
...
Follow the [Product Artifact Contract](../../references/product-artifact-contract.md). Write the living solution artifact to `product/initiatives/<initiative-id>/solution.md` and register it in that initiative's `manifest.yaml`. Use [references/solution-shaping-template.md](references/solution-shaping-template.md).
