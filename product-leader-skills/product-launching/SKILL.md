...
- identify the owner and review period for post-launch outcome learning

## Output

Follow the [Product Artifact Contract](../../references/product-artifact-contract.md). Write the launch artifact to `product/initiatives/<initiative-id>/launch.md` and register it in `manifest.yaml`, using [references/product-launching-template.md](references/product-launching-template.md).
...
Recommend `product-learning` after launch to assess outcomes and route learning back to the relevant opportunity, portfolio, market, or strategy artifact.
